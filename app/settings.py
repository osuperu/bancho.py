...
OSU_DAILY_API_KEY = os.environ["OSU_DAILY_API_KEY"]
...
BSS_BEATMAPSET_MAX_SIZE = int(os.environ["BSS_BEATMAPSET_MAX_SIZE"])
BSS_BEATMAPSET_MIN_LENGTH = float(os.environ["BSS_BEATMAPSET_MIN_LENGTH"])
BSS_OSZ2_SERVICE_URL = os.environ["BSS_OSZ2_SERVICE_URL"]
